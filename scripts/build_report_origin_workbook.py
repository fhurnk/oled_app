...
The script is intentionally standalone. It can write directly to an Origin OPJU
project through OriginPro Python, or write an xlsx preview workbook for debugging.
"""
