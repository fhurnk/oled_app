...
Стабильный формат: `vMAJOR.MIDDLE.MINOR`. Для экспериментальной сборки допускается суффикс prerelease, например `v1.8.0-alpha.2`.
