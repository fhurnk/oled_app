...
Версия сервиса: `v1.8.4`. Сервис управляет Canon через `gphoto2` и даёт основному приложению HTTP API для ручной проверки:
