...
- The modular GUI shell, start screen, series measurement menu, settings window, and IVL window now live in `oled_app/gui/app.py`, `oled_app/gui/start_screen.py`, `oled_app/gui/measurement_menu.py`, `oled_app/gui/settings_window.py`, and `oled_app/gui/ivl_window.py`.
