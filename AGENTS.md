...
The current project release is `v1.9.0-beta`. Keep `APP_VERSION`, `CHANGELOG.md`, `docs/versions/v1.9.0-beta.md`, visible docs, tag, and GitHub Release synchronized. Create a later version only when the user explicitly requests the next project version.
