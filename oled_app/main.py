...
def scaffold_status_lines() -> list[str]:
    return [
        ...
        "Migrated package layers: constants, settings, utils, series, hardware, reports, measurements.ivl, measurements.spectrum, measurements.stability, gui.widgets, gui.progress, gui.app, gui.start_screen, gui.measurement_menu",
    ]
