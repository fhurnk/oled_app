...
- workflow стабильности в `oled_app/measurements/stability.py` поддерживает динамические уставки: токовый режим сохраняет обратную связь, а режим напряжения подаёт новую цель сразу; beta-GUI имеет кнопки уменьшения и увеличения.
